        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="product-status-wrap">
                    ...
                    <h5 style="margin-left: 3.5em ;color: brown;">ĐỊA CHỈ: <span style="color: chartreuse; margin-left: 4.3em;"><i><b>{{$admin->address}}</b></i></span></h5>
                    ...
                    <h5 style="margin-left: 3.5em ;color: brown;">NGÀY THAM GIA: <span style="color: chartreuse; margin-left: "><i><b>{{$admin->created_at}}</b></i></span></h5>
                </div>
            </div>
