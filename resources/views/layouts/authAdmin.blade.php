...
<head>
    ...
    <!-- forms CSS
		============================================ -->
    <link rel="stylesheet" href="admins/css/form/all-type-forms.css">
    <!-- style CSS
        ============================================ -->
...
<body>
    ...
    <!-- tab JS
		============================================ -->
    <script src="admins/js/tab.js"></script>
    <!-- icheck JS
		============================================ -->
    <script src="admins/js/icheck/icheck.min.js"></script>
    <script src="admins/js/icheck/icheck-active.js"></script>
    <!-- plugins JS
		============================================ -->
