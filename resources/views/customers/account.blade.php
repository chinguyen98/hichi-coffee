    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card customerForm">
                <div class="card-header text-center text-uppercase">Thông tin tài khoản</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('customers.accounts.update') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right"> Tên khách hàng </label>
